...
def train_model(model, train_dataloader, val_dataloader, num_epochs=15, learning_rate=0.001, accumulation_steps=4, save_path="model_checkpoint.pth"):
...
audio_file = "/Users/dmondal/Documents/iam/testing/harsh01.wav"  # Path to the audio file for prediction
processor = Wav2Vec2Processor.from_pretrained("facebook/wav2vec2-base-960h")
