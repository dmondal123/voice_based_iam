...
class CNNModel(nn.Module):
    def __init__(self, num_classes):
        ...
        #self.bn1 = nn.BatchNorm1d(80000)
        self.pool = nn.MaxPool1d(kernel_size=2, stride=2)
        self.conv2 = nn.Conv1d(in_channels=16, out_channels=32, kernel_size=5, stride=1, padding=2)
        #self.bn2 = nn.BatchNorm1d(40000)
        self.conv3 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=5, stride=1, padding=2)
        #self.bn3 = nn.BatchNorm1d(20000)
        self.fc1 = nn.Linear(64 * 10000, 256)  # Adjusted for input size 80000 and pooling
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 64 * 10000)  # Adjusted for input size 80000 and pooling
...
def train_model(model, train_dataloader, val_dataloader, num_epochs=4, learning_rate=0.001, accumulation_steps=4, save_path="model_checkpoint.pth"):
